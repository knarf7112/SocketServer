...
namespace Test_Apple_APNs_PushNotification
{
    class Program
    {
        ...
        static string DeviceToken = "c1564dd73cd73a003d2ad143d96c9e6d651f8b48b45ba8c0ae9c5db87513fde8";
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            payload.Alert.Body = "Test 國字來一下 Content";
            payload.Badge = 3;
        ...
        static string SendAPNS(string deviceToken, string content)
        {
            ...
            int port = 2195;//2195;//2196
            string password = "AllPay";//

            //certificate load 需要去Apple申請App的憑證才有此檔
            string certificatepath = "allpay_apns_dev.p12";// "aps_developer_allpay.p12";//bin/debug
